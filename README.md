...
# CODE Requirements:
* Dataset (I suggest using [**Mappilary Vistas**](https://www.mapillary.com/dataset/vistas) or Cityscpaes as training datasets. For evaluation PASS, VISTAS or Cityscapes can be tested using this code.)
